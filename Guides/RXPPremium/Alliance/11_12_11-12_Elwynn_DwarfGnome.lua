...
-- Original guide: 11-12 Elwynn (Dwarf/Gnome)

TurtleGuide:RegisterGuide("RXP Premium/11-12 Elwynn (Dwarf/Gnome)", "RXP Premium/12-14 Loch Modan (Dwarf/Gnome)", "Alliance", function()

return [[

N 11-12 Elwynn (Dwarf/Gnome) |N|Converted from RestedXP guide|

N Cast [Life Tap] repeatedly until you have <10% health while on the way to Dungar Longdrink |SK| |C|Warlock| |M|speedrun|
...
A Wanted: "Hogger" |QID|176| |N|Talk to Deputy Rainer - Click the Wanted Poster - (24.5, 74.7)| |C|Warlock|
A The Collector |QID|123| |N|The [Gold Pickup Schedule] is a very rare drop. Ignore this step if you don't get it - Gruff Swiftbite a rare spawn, does have a 100% drop chance - Collect Gold Pickup Schedule (x1)| |U|1307| |SK| |C|Warlock|
N Kill Hogger. Loot him for his Claw - Hogger can spawn in multiple locations - Cast [Fear] on Hogger continously and use your regular DoTs to kill him - This quest is difficult. Find a group for him if needed. Skip this step if you're unable to find a group or solo him - Huge Gnoll Claw (1) - (27.0, 86.7) |QID|176| |C|Warlock|
A Lost Necklace |QID|85| |N|Talk to "Auntie" Bernice Stonefield - Talk to Ma Stonefield and "Auntie" Bernice Stonefield - (34.7, 84.5)|
...
T Encroaching Gnolls |QID|244| |N|Talk to Deputy Feldon - Talk to Deputy Feldon - Be careful of high level mobs en route - (30.7, 60.0)|
...
N Start casting [Life Tap] on your way back up to Gakin the Darkbinder as you will do a deathskip momentarily |SK| |C|Warlock| |M|speedrun|
...
A Red Leather Bandanas |QID|153| |N|Talk to Scout Galiaan - Talk to Scout Galiaan - (54.0, 53.0)|
f Sentinel Hill >> Get the Sentinel Hill flight path |N|Talk to Thor - Talk to Thor - (56.5, 52.6)|
H Hearthstone |C|!Paladin|
R Enter the Deeprun Tram. Take the Tram to Ironforge |N|(61.1, 11.6)| |C|Paladin| |R|Dwarf|
