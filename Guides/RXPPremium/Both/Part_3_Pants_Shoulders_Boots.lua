...
-- Original guide: Part 3: Pants, Shoulders & Boots

TurtleGuide:RegisterGuide("RXP Premium/Part 3: Pants, Shoulders & Boots", "RXP Premium/Part 4: Helm & Chest", "Both", function()

return [[

N Part 3: Pants, Shoulders & Boots |N|Converted from RestedXP guide|
...
N Start looking for a solid 5-man group capable of clearing the undead side of Stratholme within 45 minutes |SK|
